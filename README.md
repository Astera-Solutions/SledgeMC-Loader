# ⚙️ Sledge Loader (1.21.4)

The **Core Engine** of SledgeMC for Minecraft **1.21.4**.

This version of **Sledge Loader** is specifically built and optimized for Minecraft 1.21.4.
...
## ✨ Features
- **Version Specific**: Hardcoded to target and support MC 1.21.4.
...
./gradlew clean build
```
The shadow (all-in-one) artifact will be located in `build/libs/sledge-loader-1.21.4-all.jar`.
